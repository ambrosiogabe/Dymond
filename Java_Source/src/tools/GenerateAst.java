...
public class GenerateAst {
	public static void main(String[] args) throws IOException {
		...
		defineAst(outputDir, "Expr", Arrays.asList(
				...
				"Subscript   : Expr left, Expr subNum, Token operator",
				"Set         : Expr object, Token name, Expr value, Token equals",
		...
		defineAst(outputDir, "Stmt", Arrays.asList(
				...
				"Function   : Token name, List<Expr.Assign> parameters, List<Stmt> body",
				"If         : Expr condition, Stmt thenBranch, Stmt elseBranch",
				"Next       : Token keyword",
				"Return     : Token keyword, Expr value",
				"Var        : Token name, Expr initializer",
				"While      : Expr condition, Stmt body",
				"For      : Expr condition, Stmt body, Stmt increment"
		));
	}
